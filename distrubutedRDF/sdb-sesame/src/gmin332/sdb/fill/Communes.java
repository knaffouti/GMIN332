...
public class Communes {
	...
	public static final String rdf_file = "jeuxDonnees3.rdf";
	...
	public static void main(String[]args){
		...
		try{
			...
			Model tmp = null;
			if (conn.containsModel("Communes")){ 
				System.out.println("Opening existing model");
				tmp = maker.openModel("Communes",true); }
				else {
					System.out.println("Creating new model");
					tmp = maker.createModel("Communes",true);
				}
